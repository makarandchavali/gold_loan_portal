...
export const teamsData = [
  {
    ...
    employees: [
      { id: 'EMP_A1', name: 'Krishna', phone: '+917795791587', email: 'amit.sharma@iil.com' },
      { id: 'EMP_A2', name: 'Siva Reddy', phone: '+919985669678', email: 'sneha.patel@iil.com' },
      { id: 'EMP_A3', name: 'Rajesh Kumar', phone: '+919876543212', email: 'rahul.verma@iil.com' },
      { id: 'EMP_A4', name: 'Priya Sharma', phone: '+919876543213', email: 'priya.gupta@iil.com' }
    ]
  },
  {
    teamId: 'TEAM_B',
    ...
    employees: [
      { id: 'EMP_B1', name: 'Gowtham', phone: '+919494586777', email: 'vikram.singh@iil.com' },
      { id: 'EMP_B2', name: 'Pooja', phone: '+919010526462', email: 'anita.desai@iil.com' },
